...
class _PageFourState extends State<PageFour> {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Form(
        key: widget.model.formKeyPageFour,
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                Radio(
                  ...
                  groupValue: widget.model.selectedValuePageFour,
                  value: 0,
                  onChanged: widget.model.onRadioButtonChangedPageFour(),
                ),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
            ...
            GestureDetector(
              onTap: () {
                widget.model.formKeyPageFour.currentState.save();
                Navigator.push(
                  context,
                  MaterialPageRoute(
